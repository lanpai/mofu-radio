...
class Controls extends Component {
    ...
    render() {
        let toggleButton = <path fill='RGB(var(--highlight))' d='M8,5.14V19.14L19,12.14L8,5.14Z' />;
        if (this.props.playing)
            toggleButton = <path fill='RGB(var(--highlight))' d='M14,19H18V5H14M6,19H10V5H6V19Z' />;

        let favoriteButton = <path fill='RGB(var(--highlight))' d='M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4M9.75,7.82C8.21,7.82 7,9.03 7,10.57C7,12.46 8.7,14 11.28,16.34L12,17L12.72,16.34C15.3,14 17,12.46 17,10.57C17,9.03 15.79,7.82 14.25,7.82C13.38,7.82 12.55,8.23 12,8.87C11.45,8.23 10.62,7.82 9.75,7.82Z' />;
        if (this.props.favorites.indexOf(this.props.currentID) != -1)
            favoriteButton = <path fill='RGB(var(--highlight))' d='M12,2C6.47,2 2,6.5 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M9.75,7.82C10.62,7.82 11.45,8.23 12,8.87C12.55,8.23 13.38,7.82 14.25,7.82C15.79,7.82 17,9.03 17,10.57C17,12.46 15.3,14 12.72,16.34L12,17L11.28,16.34C8.7,14 7,12.46 7,10.57C7,9.03 8.21,7.82 9.75,7.82Z' />;
